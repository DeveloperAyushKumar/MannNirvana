    ...
    <>
      <div className="w-full h-screen flex items-center">
        <button
          ...
          className="absolute top-3 left-3 z-10 font-extrabold border border-purple-300 rounded-lg p-2 bg-red-400 flex items-center gap-2 text-white"
        >
          <FaTimes /> EXIT
        </button>

        <div className="main-meet flex w-11/12 h-4/5 m-auto items-center justify-around">
          <div className="w-1/3 h-1/2 min-w-[640px] min-h-[480px] rounded-2xl bg-[#D4C1EC] text-slate-500 shadow-xl border-white border-8 flex flex-col p-4">
          ...
          <div className="h-full flex flex-col justify-center items-center gap-16">
            <div className="w-60 h-40 bg-slate-600 rounded-2xl text-white text-center flex flex-col">
              <div className="w-full h-[70%] bg-red-400 rounded-t-2xl flex items-center justify-center text-3xl">
              ...
              <div className="flex w-full h-[30%] justify-around rounded-b-2xl">
                <button
                  className={`h-full w-[49%] bg-slate-400 rounded-bl-2xl hover:bg-slate-600 flex items-center justify-center gap-2 ${
                ...
                <button
                  className={`rounded-br-2xl h-full w-[49%] bg-slate-400 hover:bg-slate-600 flex items-center justify-center gap-2 ${
                    isSpeaking || ifStart !== 1 ? "opacity-50 cursor-not-allowed" : ""
                  }`}
                  disabled={isSpeaking || ifStart !== 1}
            ...
            <div className="w-80 h-fit bg-slate-500 rounded-lg border-white border-3 text-red-400 font-semibold">
              <WebStream />
            </div>
          </div>
        </div>
      ...
      {exitOption && (
        <div className="w-full h-full backdrop-blur-lg absolute top-0 bg-[rgba(23, 23, 23, 0.44)] flex items-center justify-center">
          <div className="w-[300px] h-28 flex flex-col items-center justify-around">
            <div className="w-full h-[77px] bg-slate-400 rounded-t-2xl p-2 text-center">
            ...
            <div className="flex w-full h-[33px] justify-around rounded-b-2xl">
              ...
              <button
                className="rounded-br-2xl h-full w-[149px] bg-red-400 flex items-center justify-center gap-2 text-white"
                onClick={backToHome}
              >
                <FaHome /> Yes
              </button>
